...
<div class="row">
	<div class="col-md-12">
		...
		<div class="panel panel-default" style="box-shadow: 15px 15px 30px #bebebe,
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label">Image Type: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					    <!-- the avatar markup -->
							<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="productImage" placeholder="Print Name" name="productImage" class="file-loading" style="width:auto;"/>
					    </div>
	        ...
	        <div class="form-group">
	        	<label for="productName" class="col-sm-3 control-label">Type Name: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="Print Name" name="productName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    
